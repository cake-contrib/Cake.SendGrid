...
var solutionFilePath          = "./Source/Cake.SendGrid.sln";
var solutionDirectoryPath     = "./Source/Cake.SendGrid";
var title                     = "Cake.SendGrid";
var resharperSettingsFileName = "Cake.SendGrid.sln.DotSettings";
var repositoryOwner           = "cake-contrib";
var repositoryName            = "Cake.SendGrid";
var appVeyorAccountName       = "cakecontrib";
var appVeyorProjectSlug       = "cake-SendGrid";

// NOTE: Only populate this, if required, but leave as is otherwise.
var dupFinderExcludePattern   = new string[] { rootDirectoryPath + "/Source/Cake.SendGrid.Tests/*.cs" };
